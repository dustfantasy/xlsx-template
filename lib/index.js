                    ...
                    self.extractPlaceholders(string).forEach(function(placeholder) {
                        ...
                        if(placeholder.full && placeholder.type === "table" && substitution instanceof Array) {
                            ...
                            if (placeholderRows[placeholder.name]) {
                                startRow = self.cloneElement(placeholderRows[placeholder.name][0])
                                startRow.attrib.r +=rowIndex - placeholderRows[placeholder.name][1]
				                cell.attrib.r = self.getCurrentCell(originalCell, startRow.attrib.r, cellsInserted);
                            }
